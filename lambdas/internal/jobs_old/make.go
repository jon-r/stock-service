...
func MakeJob(provider providers_old.ProviderName, tickerId string, jobType JobTypes, newUuid UuidGen) JobAction {
	return JobAction{
		JobId:    newUuid(),
		Provider: provider,
		Type:     jobType,
...
func MakeBulkJob(provider providers_old.ProviderName, tickerIds []string, jobType JobTypes, newUuid UuidGen) JobAction {
...
func MakeCreateJobs(provider providers_old.ProviderName, tickerId string, newUuid UuidGen) *[]JobAction {
	newItemActions := []JobTypes{
		LoadTickerDescription,
		LoadHistoricalPrices,
		// TODO jobs_old.LoadHistoricalDividends,
		// TODO jobs_old.LoadTickerIcon,
	}
...
func MakeUpdateJobs(tickers []providers_old.TickerItemStub, newUuid UuidGen) *[]JobAction {
